...
Текущие рабочие документы находятся в `docs/README.md` (единый индекс) и связанных файлах в `docs/`.
Исторические разовые планы и аудит-заметки удалены из репозитория, чтобы не создавать конфликт с актуальными процессами.

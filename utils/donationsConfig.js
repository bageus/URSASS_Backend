...
const DONATIONS_CONFIG = {
  starter_pack: {
    ...
    price: price('0.02', '2'),
    starsAmount: Number(process.env.DONATION_STARTER_PACK_STARS || 2),
    purchaseLimit: 'once',
  ...
  basic_pack: {
    ...
    merchantWallet: DEFAULT_MERCHANT_WALLET,
    price: price('0.09', '9'),
    starsAmount: Number(process.env.DONATION_BASIC_PACK_STARS || 9),
  ...
  advanced_pack: {
    ...
    merchantWallet: DEFAULT_MERCHANT_WALLET,
    price: price('0.17', '17'),
    starsAmount: Number(process.env.DONATION_ADVANCED_PACK_STARS || 17),
    purchaseLimit: 'unlimited',
    ttlMinutes: TTL_MINUTES,
    requiredConfirmations: REQUIRED_CONFIRMATIONS,
    grant: { gold: 400, silver: 400 }
  ...
  super_pack: {
    ...
    merchantWallet: DEFAULT_MERCHANT_WALLET,
    price: price('0.40', '40'),
    starsAmount: Number(process.env.DONATION_SUPER_PACK_STARS || 40),
    purchaseLimit: 'unlimited',
    ttlMinutes: TTL_MINUTES,
    requiredConfirmations: REQUIRED_CONFIRMATIONS,
  ...
  gold_pack: {
    ...
    merchantWallet: DEFAULT_MERCHANT_WALLET,
    price: price('0.05', '5'),
    starsAmount: Number(process.env.DONATION_GOLD_PACK_STARS || 5),
    purchaseLimit: 'unlimited',
    ttlMinutes: TTL_MINUTES,
    requiredConfirmations: REQUIRED_CONFIRMATIONS,
  ...
  silver_pack: {
    ...
    merchantWallet: DEFAULT_MERCHANT_WALLET,
    price: price('0.03', '3'),
    starsAmount: Number(process.env.DONATION_SILVER_PACK_STARS || 3),
    purchaseLimit: 'unlimited',
    ttlMinutes: TTL_MINUTES,
    requiredConfirmations: REQUIRED_CONFIRMATIONS,
